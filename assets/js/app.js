...
/* AngusBeef Custom Function to take steam id and return player rank */
function getRank(name) {
	if(name == "76561198147632050") {
		return "Owner";
	}
	if(name == "NoobSight") {
		return "Admin";
...
function GameDetails( servername, serverurl, mapname, maxplayers, steamid, gamemode ) {
	// This first part returns null if you are running the page through a browser instead of the game
